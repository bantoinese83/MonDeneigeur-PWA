...
interface CircularCalendarBannerProps {
  className?: string
}

export function CircularCalendarBanner({ className = '' }: CircularCalendarBannerProps) {
  ...
  return (
    <div className={`relative w-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 text-white shadow-lg ${className}`}>
